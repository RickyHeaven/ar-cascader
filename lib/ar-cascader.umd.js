...
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__1938__) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE__1938__;
...
var external_root_area_data_commonjs_area_data_commonjs2_area_data_amd_area_data_ = __webpack_require__(1938);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/thread-loader@3.0.4_webpack@5.88.2/node_modules/thread-loader/dist/cjs.js!./node_modules/.pnpm/babel-loader@8.3.0_a7bz5yhgcoab2comip4bcc2pf4/node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/.pnpm/vue-loader@15.10.1_frtorbnrps7mwsvjkhwiayewvm/node_modules/vue-loader/lib/index.js??vue-loader-options!./src/ar-cascader.vue?vue&type=script&lang=js&
...
/* harmony default export */ var ar_cascadervue_type_script_lang_js_ = ({
  ...
  methods: {
    init() {
      let proData = [];
      for (const p in external_root_area_data_commonjs_area_data_commonjs2_area_data_amd_area_data_.pca['86']) {
        let proitem = {
          value: p,
    ...
    loadData(item, callback) {
      let childData = [];
      let childs = external_root_area_data_commonjs_area_data_commonjs2_area_data_amd_area_data_.pcaa[item.value];
      for (const c in childs) {
        if (childs.hasOwnProperty(c)) {
          ...
          if (external_root_area_data_commonjs_area_data_commonjs2_area_data_amd_area_data_.pcaa[childitem.value] && levelShow(this.showLevel, item.value)) {
