...
;// CONCATENATED MODULE: external "@zhangqingcq/china-area-data"
var china_area_data_namespaceObject = require("@zhangqingcq/china-area-data");
var china_area_data_default = /*#__PURE__*/__webpack_require__.n(china_area_data_namespaceObject);
;// CONCATENATED MODULE: external "lodash-es"
var external_lodash_es_namespaceObject = require("lodash-es");
...
/* harmony default export */ var ar_cascadervue_type_script_lang_js = ({
  ...
  methods: {
    getValue(v, key, type, source) {
      ...
      const l1 = (0,external_lodash_es_namespaceObject.find)((china_area_data_default()), _e => _e[key] === _v0);
      if (l1) {
        this.setResult(t, l1, type);
        if (this.level === 0 || _v1 === undefined) {
          return t;
        }
        const l2 = (0,external_lodash_es_namespaceObject.find)(l1.children, _e => _e[key] === _v1);
        if (l2) {
          this.setResult(t, l2, type);
          if (this.level === 1 || _v2 === undefined) {
            return t;
          }
          const l3 = (0,external_lodash_es_namespaceObject.find)(l2.children, _e => _e[key] === _v2);
          if (l3) {
